...
along with &ldquo;language-adversarial&rdquo; training (inspired by aversarial training;
...
<figure style="max-width: 40%; float: right;">
<img src="/graphics/illustrations/2017-09-12/freitas.jpg" alt="Conditional policies for one-shot imitation learning." style="max-width: 100%" />
<figcaption>
...
do is performed in a context, we are built with a lot of prior knowledge.
The process of learning in a one-year-old child, is not a one-year long process.
An child is itself a product of a process that took millions of years.
How do you learn a system that has the capacity to continue learning.
...
has resources in a few languages but want the systems to also work on languages with lesser resources.
...
**Language grounding**, besides covered thoroughly by Freitas, a few papers also considered
language grounding, this of course is closely connected to multi-modal learning which is covered
above.
