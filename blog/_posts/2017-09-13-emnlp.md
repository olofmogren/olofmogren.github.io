...
{% if page.tweetid %}
<div style="border: #ccc solid 1px; overflow: auto;">
...
<div style="position: relative; bottom: 4px; left: -4px; overflow-y: hidden; overflow-x: hidden; width: 200px; height: 32px;" scrolling="no">
