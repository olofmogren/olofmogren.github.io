...
<div style="width: 100%; border: #ccc solid 1px;">
<div style="float: left;"><p>Retweet&nbsp;or&nbsp;comment&nbsp;this&nbsp;on&nbsp;Twitter:</p></div>
<div style="overflow-y: hidden; overflow-x: hidden; width: 60%; height: 24px; float: left;" scrolling="no">
<div style="position: relative; bottom: 8px; overflow-y: hidden; overflow-x: hidden; width: 600px; height: 32px;" scrolling="no">
